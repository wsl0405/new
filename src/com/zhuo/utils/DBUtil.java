...
public class DBUtil {
    ...
    private static Connection getConnection() {
        String url = "jdbc:mysql://127.0.0.1:3306/fivenews?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC";
    ...
    public static String delNEW(int xwid) {
        synchronized (del_New) {
            ...
            try {
                ...
                while(res.next())
                {
                    FileUtiles.DeleteFolder(com.zhuo.utils.Constants.picPath+res.getString(1));
                }
