...
public class Constants {
    ...
    public static final String GET_YG="<#GET_YG#>";//获得角色信息
    ...
    public static final String ADD_JSQX_BY_QXMC="<#ADD_JSQX_BY_QXMC#>";//给指定角色添加指定权限
    public static final String SC_QX="<#SC_QX#>";//删除权限
    public static final String XG_YG="<#XG_YG#>";//修改员工
    public static final String GET_BM="<#GET_BM#>";//获得部门
    ...
    public static final String ADD_NEW="<#ADD_NEW#>";//添加新闻
    ...
    public static final String XG_LM="<#XG_LM#>";//修改栏目
    ...
    public static final String TRAN_XW="<#TRAN_XW#>";//调整新闻顺序
    ...
    public static final String picPath="D:////picture//";
}
